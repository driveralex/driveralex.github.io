...
<span class="token punctuation">{</span>
  ...
  igraph
<span class="token punctuation">}</span>
</code></pre>`,5),m=[d],_={setup(o,{expose:n}){return n({frontmatter:{meta:[]}}),l({meta:[]}),(h,b)=>(a(),p("div",i,m))}},g={class:"allContent text-center"},S=r({setup(o){return(n,e)=>{const s=c;return a(),p("div",g,[t(k(_),{class:"md"}),t(s,{nextSectionName:"Graph scale free",nextRoute:"/complexSystem/random-graph-models/graph-scale-free",previousSectionName:"Erdos-Renyi model",previousRoute:"/complexSystem/random-graph-models/erdos-renyi-model"})])}}});export{S as default};
