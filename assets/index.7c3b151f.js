import{_ as l}from"./ButtonSection.a2e21b1c.js";import{v as i,o as t,b as p,e as n,f as o,g as k,h as r,d as c,l as d}from"./vendor.d933a0e7.js";import"./app.3607838d.js";const m={class:"prose prose-sm m-auto text-left"},g=n("h1",null,"Representations of graph and first metrics",-1),h=n("h3",null,[n("strong",null,"1) Matrix"),o(),n("eq",null,[n("span",{class:"katex"},[n("span",{class:"katex-mathml"},[n("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[n("semantics",null,[n("mrow",null,[n("mo",null,"\u2194")]),n("annotation",{encoding:"application/x-tex"},"\\leftrightarrow")])])]),n("span",{class:"katex-html","aria-hidden":"true"},[n("span",{class:"base"},[n("span",{class:"strut",style:{height:"0.3669em"}}),n("span",{class:"mrel"},"\u2194")])])])]),o(),n("strong",null,"List")],-1),f=k(`<p>A graph may be represented by its adjacency matrix or its adjacency list. Below is a function that gets the adjacency list from the adjacency matrix :</p><pre class="language-r"><code class="language-r">fromMatriceToList <span class="token operator">&lt;-</span> <span class="token keyword">function</span><span class="token punctuation">(</span>mat<span class="token punctuation">)</span>
...
<span class="token punctuation">{</span>
  ...
  lst
<span class="token punctuation">}</span>
</code></pre>`,12),y=[g,h,f],w={setup(e,{expose:s}){return s({frontmatter:{meta:[]}}),i({meta:[]}),(b,x)=>(t(),p("div",m,y))}},_={class:"allContent text-center"},q=r({setup(e){return(s,u)=>{const a=l;return t(),p("div",_,[c(d(w)),c(a,{nextSectionName:"Breadth-first search algorithm and applications",nextRoute:"/complexSystem/getting-started/breadth-first-search-algorithm-and-applications",previousSectionName:"Getting Started",previousRoute:"/complexSystem/getting-started"})])}}});export{q as default};
